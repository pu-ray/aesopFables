package com.gamecodeschool.aesopfables;
...
//        FloatingActionButton Fable1 = null;
...
//        FloatingActionButton Fable2 = null;
...
//        FloatingActionButton Fable3 = null;
...
//        FloatingActionButton Fable4 = null;
...
//        FloatingActionButton Fable5 = null;
        btnFable5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(),TheFisherandtheLittleFishFable.class));
            }
        });

//        FloatingActionButton Fable6 = null;
...
//        FloatingActionButton Fable7 = null;
        ...
        btnFable8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(),TheMountainsinLabourFable.class));
            }
        });

//        FloatingActionButton Fable9 = null;
        btnFable9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(),TheStageatthePool.class));
            }
        });
